...
Vue SFC を簡易レンダリングし、**CSS をすべてインライン化した 1 枚の HTML** を出力する CLI です。
ADE「pike」のエディタの Preview が外部ツールとして呼び出し、人間向けのプレビューに使っています（pike 0.58.0 から。pike の Preview の欄からも入れられます）。
